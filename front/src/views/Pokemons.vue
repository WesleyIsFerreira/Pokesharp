<template>
  <div>
    ...
    <!-- Modal -->
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="createAbilityModal" tabindex="-1" aria-labelledby="createAbilityModalTitle" aria-modal="true" role="dialog">
